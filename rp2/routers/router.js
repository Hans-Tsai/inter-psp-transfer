...
router.post('/psp2/sca_verified_option', requireAuth, checkUser, controller.psp2_sca_verified_option_post);
...
router.post('/psp2/inter_psp_transfer/2pc/prepare', controller.psp2_inter_psp_transfer_2pc_prepare_post);
router.post('/psp2/inter_psp_transfer/2pc/commit', controller.psp2_inter_psp_transfer_2pc_commit_post);
router.post('/psp2/inter_psp_transfer/2pc/rollback', controller.psp2_inter_psp_transfer_2pc_rollback_post);
